...
let chatServer = ws.createServer(function (conn:any) {
	...
	conn.on('text', function (text:string) {//if we receive some text through this user
	...
	console.log('Chat socket server running on localhost:3005');
});
